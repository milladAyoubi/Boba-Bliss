...
const CartDesktop = () => {
  ...
  <div className={`${isOpen ? 'left-0 ' : '-left-full '} bg-white hidden fixed top-0 
  bottom-0 w-[500px]  shadow-2xl lg:flex lg:visible flex-col transition-all duration-300 z-10 `}>
