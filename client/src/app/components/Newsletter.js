...
const Newsletter = () => {
  return (
    <section className='mt-14 mb-24' id="promos">
        <div className='bg-newsletter text-xl container m-auto lg:min-h-[350px] h-[300px] bg-no-repeat bg-cover bg-center lg:max-h-[750px] lg:rounded-2xl flex flex-col lg:flex-row text-center lg:text-left' data-aos='fade-up' data-aos-delay='200' data-aos-duration='1200'>
           
            
            <div className=' m-auto flex flex-col gap-y-2 text-white lg:max-w-[400px]' >
                       <h1 className='text-3xl font-bold'>Sign Up For Our Newsletter Promotions</h1>
